<template>
  <section id="section-home" class="bg-white dark:bg-gray-900">
    <div
    ...
    >
      <div class="mr-auto place-self-center lg:col-span-7">
        ...
        <div class="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
          <a
            href="https://github.com/pangxiaobin/image-matting"
            target="_blank"
          ...
          <a
            v-if="locale === 'zh'"
            href="http://qm.qq.com/cgi-bin/qm/qr?_wv=1027&k=xRYVnv5ZWKwtF-rYo4axjAUWmHsnD4gI&authKey=Mmh9agdxP%2BYpAu1YmxaYr7Qj3j2jiW91NQuNEaqEmSlsit%2FOnAx54Jt5KvghoXmj&noverify=0&group_code=964721224"
            target="_blank"
            class="inline-flex items-center justify-center w-full px-5 py-3 text-sm font-medium text-center text-gray-900 border border-gray-200 rounded-lg sm:w-auto hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800"
          >
            交流群: 964721224
      ...
      <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
        <img class="h-80" :src="logo" alt="hero image" />
      </div>
    </div>
  </section>
</template>
